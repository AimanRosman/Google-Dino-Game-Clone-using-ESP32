...
void loop() {
  ...
  if (gameOver) {
    ...
    String gameOverMessage = "LAH KALAH KE?";
    int16_t x, y;
...
void playJumpBeep() {
  tone(BUZZER_PIN, NOTE_E5, 50);  // Short beep using a note from the melody
}
...
void playGameOverMelody() {
  // Calculate the duration of a whole note
  int wholenote = (60000 * 4) / tempo;
  
  // Use the Tetris melody from song.h
